...
const visitorKeys = {
    ...
    /*I */ Program: ['body'],
    /*IT*/ Property: ['key', '_methodParams' /* esprima hack */, 'value'], // FIXME: Esprima improperly calculates range
    ...
    /*IT*/ TryStatement: ['block', 'handlers', 'finalizer'],
...
function buildElementTreeItem(ast, tokens, start, end) {
    ...
    if (ast.type === 'Property' && (ast.kind === 'set' || ast.method)) {
        ast._methodParams = ast.value.params;
    }
